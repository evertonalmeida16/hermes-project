...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      ...
      <table class="table table-striped">
        ...
        <tbody>
          @foreach($data_decode->original->data as $data)
          <tr>
            ...
            <td>{{ $data->numero }}</td>
            <td>{{ $data->estado }}</td>
            <td>{{ str_replace(',', ' - ', $data->telefones) }}</td>
            <td>
            ...
            <td>
              <a href="javascript:;" onclick="confirmDelete(this)" data-href="{{route('home.destroy', $data->id)}}">
